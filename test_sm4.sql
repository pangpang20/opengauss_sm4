-- SM4扩展测试脚本 (C扩展版本)
-- 用法: gsql -d postgres -f test_sm4.sql
...
SELECT '原文' AS 类型, 'Hello OpenGauss!' AS 内容
UNION ALL
SELECT '密钥', '1234567890abcdef'
UNION ALL
SELECT '密文(hex)', sm4_c_encrypt_hex('Hello OpenGauss!', '1234567890abcdef')
UNION ALL
SELECT '解密结果', sm4_c_decrypt_hex(sm4_c_encrypt_hex('Hello OpenGauss!', '1234567890abcdef'), '1234567890abcdef');
